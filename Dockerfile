...
#   - Ex: hexpm/elixir:1.14.2-erlang-25.2.1-debian-bullseye-20230109-slim
#
...
COPY --from=builder --chown=nobody:root /app/_build/${MIX_ENV}/rel/relehelp ./
